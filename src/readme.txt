...
Функции, основанные на substring:
    ...
    isLetter(): Boolean - возвращает true, если символ является буквой
    isDigit(): Boolean - возвращает true, если символ является цифрой
    isLetterOrDigit(): Boolean - возвращает true, если символ является цифрой или буквой
    isWhitespace(): Boolean - возвращает true, если символ является, буквально, "пустым местом" - пробелом или подобными ему символами
    isUpperCase(): Boolean - true, если символ является буквой в верхнем регистре
    isLowerCase(): Boolean - противоположность предыдущему
    toUpperCase() и toLowerCase() - приводят символ к верхнему или нижнему регистру соответственно.